        ...
        if 0 <= c <= 16:
            ...
            if 0 <= r <= 4 and 38 <= c <= 40:
                fence_names = {
                    ...
                    (2, 38): ("fence_timber_corner", "Wooden Fence Corner Post (2,38)", "Wooden fence corner post joint connecting perimeter fences"),
                    ...
                    (2, 40): ("fence_timber_cross", "Wooden Fence 4-Way Cross Joint (2,40)", "4-way intersection post connecting vertical and horizontal rails"),
